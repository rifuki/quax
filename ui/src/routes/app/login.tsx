...
import { useLogin, useIsAuthenticated } from "@/features/auth/hooks/use-auth";
...
function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // AppLayout's RequireAuth automatically handles navigating to /app or /app/admin once session state applies.
    } catch { }
  };
        ...
        <div className="w-full max-w-[400px]">
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-xs font-medium text-miku-primary hover:text-miku-accent transition-colors">
                    Forgot Password?
                  </a>
                </div>
            ...
            <p className="text-center text-sm text-muted-foreground pt-2">
              ...
              <Link to="/app/register" className="font-semibold text-miku-primary hover:text-miku-accent transition-colors hover:underline">
                Sign up
              </Link>
            </p>
          </div>
